...
export const serverless_postgres_database_branch = pgTable('serverless_postgres_database_branch', {
  id: uuid("id").primaryKey(),
  database_id: uuid("database_id")
    .notNull()
    .references((): AnyPgColumn => serverless_postgres_database.id, { onDelete: "cascade" }),
